...
function rows(overrides: Partial<Record<(typeof allergenNames)[number], Pick<AllergenRow, "status" | "observation">>>) {
...
export const allergenSheets: Record<string, AllergenSheet> = {
  "perla-atlantica": {
    ...
    ingredients: ["Agua de mar canaria", "Limón canario", "Hierbas locales", "Sal volcánica", "Aceite de hierbas opcional"],
  ...
  "vieja-sancochada": {
    ...
    ingredients: ["Vieja canaria", "Papa negra canaria", "Algas", "Cebolla", "Apio", "Zanahoria", "Aceite de girasol", "Sal", "Agua"],
    containsSummary: "Pescado y apio.",
    traceNote: "Este plato puede contener trazas de otros alérgenos debido a la manipulación en cocina.",
    rows: rows({
      Pescado: { status: "Sí contiene", observation: "Contiene pescado, vieja canaria y sus espinas en el caldo." },
  ...
  "sama-roquera": {
    ...
    ingredients: ["Sama roquera", "Algas", "Cítricos", "Hierbas frescas", "Aceite de oliva virgen extra", "Sal marina"],
  ...
  "atun-rojo": {
    ...
    ingredients: ["Atún rojo", "Ponzu con soja", "Cítricos", "Wasabi", "Aceite de oliva virgen extra", "Sal", "Sésamo tostado"],
    ...
    rows: rows({
      ...
      "Granos de sésamo": { status: "Sí contiene", observation: "Presente en el topping de sésamo tostado." },
    }),
  },
  "conejo-salmorejo": {
    id: "conejo-salmorejo",
    ...
    ingredients: ["Conejo", "Tomate", "Pan", "Aceite de oliva virgen extra", "Ajo", "Vinagre", "Sal"],
    ...
    rows: rows({
      ...
      "Granos de sésamo": { status: "Sí contiene", observation: "Puede aparecer en topping o acabado." },
    }),
  },
  "cochino-negro": {
    id: "cochino-negro",
    ...
    ingredients: ["Cochino negro", "Vino tinto", "Miel de palma", "Papas", "Ajo", "Hierbas", "Aceite de oliva virgen extra", "Especias naturales"],
    ...
    rows: rows({
      ...
      "Granos de sésamo": { status: "Sí contiene", observation: "Puede contener por sésamo o topping." },
      "Dióxido de azufre y sulfitos": { status: "Sí contiene", observation: "Presente en el vino tinto." },
    }),
  },
  "cabrito-cumbre": {
    id: "cabrito-cumbre",
    ...
    ingredients: ["Cabrito", "Ajo", "Romero", "Tomillo", "Vino blanco", "Aceite de oliva virgen extra", "Sal", "Hierbas aromáticas"],
    containsSummary: "Gluten, lácteos, apio, sésamo y sulfitos.",
    traceNote: "Este plato puede contener trazas de otros alérgenos debido a la manipulación en cocina.",
    rows: rows({
      Gluten: { status: "Sí contiene", observation: "Puede contener trazas por fondos, salsas o guarniciones." },
      Lácteos: { status: "Sí contiene", observation: "Puede contener lácteos en purés o salsas, como mantequilla o nata." },
      Apio: { status: "Sí contiene", observation: "Puede contener apio en fondos o guarniciones." },
      "Granos de sésamo": { status: "Sí contiene", observation: "Puede contener por sésamo o topping." },
      "Dióxido de azufre y sulfitos": { status: "Sí contiene", observation: "Presente en el vino blanco y posibles reducciones." },
    }),
  },
  "vaca-canaria": {
    id: "vaca-canaria",
    ...
    ingredients: ["Vaca canaria", "Pimiento asado", "Cebolla", "Ajo", "Vino tinto canario", "Aceite de oliva virgen extra", "Sal", "Hierbas aromáticas"],
    containsSummary: "Gluten, lácteos, apio, sésamo y sulfitos.",
    traceNote: "Este plato puede contener trazas de otros alérgenos debido a la manipulación en cocina.",
    rows: rows({
      Gluten: { status: "Sí contiene", observation: "Puede contener trazas por fondos o guarniciones." },
      Lácteos: { status: "Sí contiene", observation: "Puede contener lácteos en puré o acabado, como mantequilla o nata." },
      Apio: { status: "Sí contiene", observation: "Puede contener apio en fondos o guarniciones." },
      "Granos de sésamo": { status: "Sí contiene", observation: "Puede contener sésamo en topping o aceite aromatizado." },
      "Dióxido de azufre y sulfitos": { status: "Sí contiene", observation: "Presente en el vino tinto canario y reducciones." },
    }),
  },
  "sorbete-lima": {
    id: "sorbete-lima",
    ...
    ingredients: ["Zumo de lima canaria", "Ralladura de lima", "Agua", "Azúcar", "Dextrosa opcional", "Estabilizante natural opcional"],
  ...
  "bienmesabe-aereo": {
    ...
    ingredients: ["Almendra molida", "Azúcar", "Yemas de huevo", "Miel", "Vino dulce", "Limón", "Canela", "Clara de huevo opcional"],
    ...
    rows: rows({
      Gluten: { status: "Sí contiene", observation: "Puede contener trazas por proceso o acompañamientos." },
      Huevos: { status: "Sí contiene", observation: "Incluye yema de huevo y opcionalmente clara." },
      "Frutos de cáscara": { status: "Sí contiene", observation: "Contiene almendra, fruto de cáscara." },
      "Granos de sésamo": { status: "Puede contener", observation: "Puede contener trazas de sésamo." },
      "Dióxido de azufre y sulfitos": { status: "Sí contiene", observation: "Contiene vino dulce con sulfitos." },
    }),
  },
  "pina-hierro": {
    id: "pina-hierro",
    ...
    ingredients: ["Piña de El Hierro", "Lima", "Miel de palma", "Agua de piña", "Hierbabuena", "Aceite de oliva virgen extra opcional"],
    containsSummary: "Lácteos si incluye helado o espuma.",
    traceNote: "Este plato puede contener trazas por contaminación cruzada en procesos y superficies.",
    rows: rows({
      Gluten: { status: "Puede contener", observation: "Puede contener trazas por contaminación cruzada, procesos o superficies." },
      Lácteos: { status: "Sí contiene", observation: "Puede contener lácteos en helado o espuma, según elaboración." },
    }),
  },
  "toffee-aireado": {
    id: "toffee-aireado",
    ...
    ingredients: ["Leche", "Nata", "Azúcar", "Mantequilla", "Sal marina", "Galleta", "Vainilla", "Cacao opcional"],
    containsSummary: "Gluten, huevos y lácteos.",
    traceNote: "Puede contener trazas de frutos de cáscara y sésamo debido a la manipulación en cocina.",
    rows: rows({
      Gluten: { status: "Sí contiene", observation: "Puede contener gluten por la galleta utilizada en la base." },
      Huevos: { status: "Sí contiene", observation: "Puede contener yema de huevo en la elaboración." },
      Lácteos: { status: "Sí contiene", observation: "Contiene leche, nata y mantequilla." },
      "Frutos de cáscara": { status: "Puede contener", observation: "Puede contener trazas de frutos de cáscara por contaminación cruzada." },
      "Granos de sésamo": { status: "Puede contener", observation: "Puede contener trazas de sésamo en la galleta." },
    }),
  },
};
